...
for items in range(len(dominoes)):
    for numbers in range(1,len(dominoes)):
       if dominoes[items].values[1] == dominoes[numbers].values[0]:
            dominoes[items+1], dominoes[numbers] = dominoes[numbers], dominoes[items+1]
